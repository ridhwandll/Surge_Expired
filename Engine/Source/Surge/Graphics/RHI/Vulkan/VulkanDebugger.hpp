...
namespace Surge
{
    inline constexpr const char* VKResultToStringyy(VkResult result)
    {
        switch (result)
        {
    ...
    public:
        ...
        void SetDebugName(const VulkanRHI& rhi, VkObjectType objType, uint64_t objectHandle, const String& name) const;
...
#define SET_VK_DEBUG_NAME(rhi, objType, objHandle, name)
#define SET_VMA_DEBUG_NAME(rhi, alloc, name)
#endif