...
namespace Surge
{
    ...
    void VulkanImGuiContext::SetDarkThemeColors()
    {
        ...
        // Headers
        colors[ImGuiCol_Header] = colorFromBytesS(51);
        ...
        // Tabs
        colors[ImGuiCol_Tab] = colorFromBytesS(56);
        colors[ImGuiCol_TabHovered] = colorFromBytesS(70);
        colors[ImGuiCol_TabActive] = colorFromBytesS(90);
        colors[ImGuiCol_TabUnfocused] = colorFromBytesS(40);
        colors[ImGuiCol_TabDimmedSelected] = colorFromBytesS(88);

        // Others
        colors[ImGuiCol_WindowBg] = themeColor;
        colors[ImGuiCol_PopupBg] = colorFromBytesS(45);
        colors[ImGuiCol_DockingPreview] = colorFromBytesS(10);
        colors[ImGuiCol_TitleBg] = { 0.12, 0.12, 0.12, 1.0 };
        colors[ImGuiCol_TitleBgActive] = { 0.14, 0.14, 0.14, 1.0 };

        colors[ImGuiCol_ScrollbarBg] = colorFromBytesS(10);
        colors[ImGuiCol_ScrollbarGrabActive] = colorFromBytes(255, 191, 0);
        colors[ImGuiCol_SliderGrab] = colorFromBytes(255, 191, 0);
        colors[ImGuiCol_SliderGrabActive] = colorFromBytes(255 - 100, 191 - 100, 0);

        //colors[ImGuiCol_Border] = colorFromBytes(255 - 120, 191 - 120, 0);
    }
}
