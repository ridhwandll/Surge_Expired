...
namespace Surge
{
    ...
    void AssetManager::DeserializeRegistry()
    {
        ...
        //    {
        //        Log<Severity::Warn>("Missing asset '{0}' found in AssetRegistry file!", metadata.Path.string());
        ...
        //    {
        //        Log<Severity::Warn>("INVALID AssetHandle found for {0}", metadata.Path.string());
        //        continue;
        //    }
        //
