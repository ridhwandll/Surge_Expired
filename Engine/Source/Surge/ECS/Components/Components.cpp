...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::SpriteRendererComponent)
    .AddVariable<&Surge::SpriteRendererComponent::Active>("Active")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::CameraComponent)
    .AddVariable<&Surge::CameraComponent::Active>("Active")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::MeshComponent)
    .AddVariable<&Surge::MeshComponent::Active>("Active")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::LightComponent)
    .AddVariable<&Surge::LightComponent::Active>("Active")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::EnvironmentComponent)
    .AddVariable<&Surge::EnvironmentComponent::Active>("Active")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::RigidbodyComponent)
    .AddVariable<&Surge::RigidbodyComponent::Active>("Active")
    .AddVariable<&Surge::RigidbodyComponent::Type>("Type")
    .AddVariable<&Surge::RigidbodyComponent::Mass>("Mass")
    .AddVariable<&Surge::RigidbodyComponent::Interpolate>("Interpolate")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::BoxColliderComponent)
    .AddVariable<&Surge::BoxColliderComponent::Active>("Active")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::CylinderColliderComponent)
    .AddVariable<&Surge::CylinderColliderComponent::Active>("Active")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::ConvexColliderComponent)
    .AddVariable<&Surge::ConvexColliderComponent::Active>("Active")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::MeshColliderComponent)
    .AddVariable<&Surge::MeshColliderComponent::Active>("Active")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::UICanvasComponent)
    .AddVariable<&Surge::UICanvasComponent::Active>("Active")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::AudioListenerComponent)
    .AddVariable<&Surge::AudioListenerComponent::Active>("Active")
SURGE_REFLECT_CLASS_REGISTER_END()

SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::AudioSourceComponent)
    .AddVariable<&Surge::AudioSourceComponent::Active>("Active")
    .AddVariable<&Surge::AudioSourceComponent::AudioClip>("AudioClipAsset")
    .AddVariable<&Surge::AudioSourceComponent::Volume>("Volume")
    .AddVariable<&Surge::AudioSourceComponent::Pitch>("Pitch")
    .AddVariable<&Surge::AudioSourceComponent::Loop>("Looping")
    .AddVariable<&Surge::AudioSourceComponent::PlayOnAwake>("PlayOnAwake")
    .AddVariable<&Surge::AudioSourceComponent::IsSpatialized>("IsSpatialized")
    .AddVariable<&Surge::AudioSourceComponent::IsStreaming>("IsStreaming")
    .AddVariable<&Surge::AudioSourceComponent::MinDistance>("MinDistance")
    .AddVariable<&Surge::AudioSourceComponent::MaxDistance>("MaxDistance")
    .AddVariable<&Surge::AudioSourceComponent::Attenuation>("Attenuation")
SURGE_REFLECT_CLASS_REGISTER_END()
