...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::SpriteRendererComponent)
    ...
    .AddVariable<&Surge::SpriteRendererComponent::TextureAsset>("Texture")
SURGE_REFLECT_CLASS_REGISTER_END()
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::MeshComponent)
    .AddVariable<&Surge::MeshComponent::MeshAsset>("MeshID")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::TextComponent)
    ...
    .AddVariable<&Surge::TextComponent::VerticalAlignment>("VerticalAlignment")
    ...
    .AddVariable<&Surge::TextComponent::FontAsset>("FontAssetID")
...
SURGE_REFLECT_CLASS_REGISTER_BEGIN(Surge::UICanvasComponent)
    .AddVariable<&Surge::UICanvasComponent::ShowCanvas>("ShowCanvas")
    .AddVariable<&Surge::UICanvasComponent::ScriptAsset>("ScriptAsset")
    .AddVariable<&Surge::UICanvasComponent::IsInstantiated>("IsInstantiated")
SURGE_REFLECT_CLASS_REGISTER_END()
